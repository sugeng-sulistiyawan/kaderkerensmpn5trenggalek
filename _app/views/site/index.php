            ...
            <div class="col-md-12">
                <div class="items_loog">
                    <div class="item-client mb-3 mb-lg-0">
                        <img width="130" src="/web/img/logos/j1.png" alt="" />
                    </div>
                    <div class="item-client mb-3 mb-lg-0">
                        <img width="130" src="/web/img/logos/w1.png" alt="" />
                    </div>
                    <div class="item-client mb-3 mb-lg-0">
                        <img width="130" src="/web/img/logos/o1.png" alt="" />
                    </div>
                    <div class="item-client mb-3 mb-lg-0">
                        <img width="130" src="/web/img/logos/h1.png" alt="" />
                    </div>
                    <div class="item-client mb-3 mb-lg-0">
                        <img width="130" src="/web/img/logos/n1.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-5 mb-4 mb-lg-0">
                <div class="amo_pic">
                    <img id="animate2" src="/web/img/app/s10-ss0.png" />
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
                ...
                <div class="title_sections mb-0">
                    ...
                    <div class="app_smartphone margin-t-4">
                        ...
                        <div class="btn--app">
                            <a class="media" href="#" target="_blank">
                                <div class="icon blue">
                                    <img width="20" src="/web/img/icons/google-play.svg" />
                                </div>
                                <div class="media-body txt">
                                    <div>
                                        <span class="c-light">Download</span>
            ...
            <div class="col-lg-5 mx-auto mb-4 mb-lg-0 order-1 order-lg-1">
                <div class="amo_pic">
                    <img id="animate3" src="/web/img/app/s10-ss03.png" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 Oitem margin-b-5">
                <div class="item_feth" data-aos="fade-up" data-aos-delay="0">
                    <div class="media">
                        <div class="icon_fr">
                            <img src="/web/img/icons/Dial-numbers.svg" />
                        </div>
                        <div class="media-body">
                            <div class="za_tzt">
            ...
            <div class="col-md-6 col-lg-4 Oitem margin-b-5">
                <div class="item_feth" data-aos="fade-up" data-aos-delay="100">
                    <div class="media">
                        <div class="icon_fr">
                            <img src="/web/img/icons/Crown.svg" />
                        </div>
                        <div class="media-body">
                            <div class="za_tzt">
            ...
            <div class="col-md-6 col-lg-4 Oitem margin-b-5">
                <div class="item_feth" data-aos="fade-up" data-aos-delay="200">
                    <div class="media">
                        <div class="icon_fr">
                            <img src="/web/img/icons/Cloud-upload.svg" />
                        </div>
                        <div class="media-body">
                            <div class="za_tzt">
                                <h3>Cloud Storage</h3>
            ...
            <div class="col-md-6 col-lg-4 Oitem">
                <div class="item_feth" data-aos="fade-up" data-aos-delay="0">
                    <div class="media">
                        <div class="icon_fr">
                            <img src="/web/img/icons/Settings-white.svg" />
                        </div>
                        <div class="media-body">
                            <div class="za_tzt">
                                <h3>Customization</h3>
            ...
            <div class="col-md-6 col-lg-4 Oitem">
                <div class="item_feth" data-aos="fade-up" data-aos-delay="100">
                    <div class="media">
                        <div class="icon_fr">
                            <img src="/web/img/icons/Pen&ruller.svg" />
                        </div>
                        <div class="media-body">
                            <div class="za_tzt">
                                <h3>UX Planning</h3>
            ...
            <div class="col-md-6 col-lg-4 Oitem">
                <div class="item_feth" data-aos="fade-up" data-aos-delay="200">
                    <div class="media">
                        <div class="icon_fr">
                            <img src="/web/img/icons/Headphones-white.svg" />
                        </div>
                        <div class="media-body">
                            <div class="za_tzt">
            ...
            <div class="col-12">
                <div class="bb_qgency_state">
                    ...
                    <div class="content_state">
                        <div class="row justify-content-md-center">
                            <div class="col-md-2">
                                <div class="it__em">
                                    <div class="icon">
                                        <img src="/web/img/icons/1f469.png" />
                                    </div>
                                    <div class="info_txt">
                                        <h4>25 000</h4>
                                        <p>
                            ...
                            <div class="col-md-2">
                                <div class="it__em">
                                    <div class="icon">
                                        <img src="/web/img/icons/2665.png" />
                                    </div>
                                    <div class="info_txt">
                                        <h4>130 000</h4>
                                        <p>
                            ...
                            <div class="col-md-2">
                                <div class="it__em">
                                    <div class="icon">
                                        <img src="/web/img/icons/1f58c.png" />
                                    </div>
                                    <div class="info_txt">
                                        <h4>7 200</h4>
                                        <p>
                            ...
                            <div class="col-md-2">
                                <div class="it__em">
                                    <div class="icon">
                                        <img src="/web/img/icons/1f647-2640.png" />
                                    </div>
                                    <div class="info_txt">
                                        <h4>15 320</h4>
                                        <p>
                    ...
                    <div class="users_profile">
                        <img src="/web/img/persons/02.png" />
                        <img src="/web/img/persons/03.png" />
                        <img src="/web/img/persons/05.png" />
                        <img src="/web/img/persons/15.png" />
                        <img src="/web/img/persons/08.png" />
                        <img src="/web/img/persons/06.png" />
                        <img src="/web/img/persons/01.png" />
                    </div>
                    <div class="link_state">
                        ...
                        <a href="#" class="btn btn_xl_primary btn_touch rounded-8">
                            <img src="/web/img/icons/1f607.png" />
                            Get a touch
                        </a>
                    </div>
                </div>
