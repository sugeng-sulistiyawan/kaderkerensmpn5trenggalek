...
<section class="about_cc_grid padding-py-12" id="About">
  <div class="container">
    ...
    <div class="margin-t-12" data-aos="fade-up" data-aos-delay="0">
      <img src="<?= $config->assets ?>/refs/about-1.jpg" alt="" class="w-100">
    </div>
  </div>
</section>
<!-- End. about_cc_grid -->
...
<section class="faq_section padding-py-6 mt-0 w-100">
  <div class="container">
    ...
    <img src="<?= $config->assets ?>/refs/struktur-org.png" alt="" class="w-100" data-toggle="collapse" data-target=".collapsess">
...
<section class="service__workspace padding-py-6 mt-0 w-100">
  <div class="container">
    ...
    <?php require __DIR__ . '/_tentang-struktural.php' ?>
    <?php require __DIR__ . '/_tentang-pokja-1.php' ?>
    <?php require __DIR__ . '/_tentang-pokja-2.php' ?>
    <?php require __DIR__ . '/_tentang-pokja-3.php' ?>
    <?php require __DIR__ . '/_tentang-anak-asuh.php' ?>
